...
namespace Destructible2D
{
		...
		where T : MonoBehaviour
	{
		...
		protected void DrawDefault(string propertyPath, ref bool modified, string overrideTooltip = null, string overrideText = null)
		{
		...
		protected void DrawDefault(string propertyPath, ref bool modified1, ref bool modified2, string overrideTooltip = null, string overrideText = null)
		{
			if (Draw(propertyPath, overrideTooltip) == true)
			{
				modified1 = true;
